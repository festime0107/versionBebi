...
const numbers = [
  { emoji: '1️⃣', label: '1', audio: '/audio/numra/nje.mp3' },
  { emoji: '2️⃣', label: '2', audio: '/audio/numra/dy.mp3' },
  { emoji: '3️⃣', label: '3', audio: '/audio/numra/tre.mp3' },
  { emoji: '4️⃣', label: '4', audio: '/audio/numra/kater.mp3' },
  { emoji: '5️⃣', label: '5', audio: '/audio/numra/pese.mp3' },
  { emoji: '6️⃣', label: '6', audio: '/audio/numra/gjashte.mp3' },
  { emoji: '7️⃣', label: '7', audio: '/audio/numra/shtate.mp3' },
  { emoji: '8️⃣', label: '8', audio: '/audio/numra/tete.mp3' },
  { emoji: '9️⃣', label: '9', audio: '/audio/numra/nente.mp3' },
  { emoji: '🔟', label: '10', audio: '/audio/numra/dhjete.mp3' },
